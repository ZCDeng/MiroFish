...
class GraphBuilderService:
    ...
    def _parse_ontology_to_entity_types(self, ontology: Dict[str, Any]) -> Dict[str, type[BaseModel]]:
    ...
    def _get_graph_info(self, graph_id: str) -> GraphInfo:
        ...
        async def _get_info():
            ...
            try:
                ...
                entity_types = [r["label"] for r in records if r["label"] not in ["EntityNode", "Node"]]
